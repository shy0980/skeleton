...
async function seed() {
  ...
  const kyle = await prisma.user.create({ data: { 
    name: "Kyle",
    email: "laughygamer@gmail.com",
    password: "laughy0980",
    etc1: 2,
    etc2: "Gaming",
    etc3: "boing",
  ...
  const sally = await prisma.user.create({ data: { 
    name: "Sally", 
    email: "shantanu0980@gmail.com",
    password: "shantanu0980",
    etc1: 3,
    etc2: "Cricket",
    etc3: "Chandigard",
    verified: true,
